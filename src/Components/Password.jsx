...
const Password = (props) => {
    const userEmail =props.location.state.name;
    ...
    <section className="flex justify-center items-center mt-14">
      <div className="login-container">
        <div className="login-container-padding">
          <div className="google-logo text-center mx-auto">
            <svg
              viewBox="0 0 75 24"
              width="75"
              height="24"
            ...
            <div className="space-y-4">
              <div className="from-control">
                <input
                  ...
                  className="w-full px-3 py-4 mt-8 border focus:outline-blue-600 rounded-md dark:border-[#dadce0] dark:bg-white dark:text-black"
                />
                <div className="flex justify-start text-xs dark:text-blue-500 font-semibold mt-2">
                  <Link to="/">Show password</Link>
                </div>
              </div>
            </div>

            <div className="space-y-2 flex items-center justify-between mt-20">
              <div>
              ...
              <div>
                <button
                  type="submit"
                  className="w-full px-7 py-2 font-semibold rounded-md dark:bg-blue-500 dark:text-white"
                >
                  Send
                </button>
              </div>
